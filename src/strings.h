...
const char L_BYPASS[]                               PROGMEM = "BYPASS";
const char L_DRY_CONTACT[]                          PROGMEM = "DRY.CONTACT";
...
const char S_BYPASS_RELAY[]                         PROGMEM = "bypassRelay";
...
const char S_DRY_CONTACT[]                          PROGMEM = "dryContact";
const char S_DISABLE_BYPASS_RELAY[]                 PROGMEM = "disableBypassRelay";
...
const char S_MANUAL_CONTROL[]                       PROGMEM = "manualControl";
...
const char S_MESSAGE[]                              PROGMEM = "message";
...
const char S_SOURCE[]                               PROGMEM = "source";
...
const char S_SUPPORTED[]                            PROGMEM = "supported";
